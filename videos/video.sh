...
#ffmpeg -f image2 -r 4 -i %04d.jpg -an -vcodec libx264 -pix_fmt yuv420p -s 960x540 video.mp4
ffmpeg -f image2 -r 5 -i %04d.jpg -an -vcodec libx264 -pix_fmt yuv420p -s 960x540 video.mp4
